...
public class CapeFunctions {
    ...
    public static void loadPlayerCape(GameProfile player, String cape, ReturnCapeTexture response) {
...
//                NativeImageBackedTexture nIBT = getCapeFromURL(String.format("http://s.optifine.net/capes/%s.png", player.getName()));
                NativeImageBackedTexture nIBT = getCapeFromURL(cape);
                if (nIBT == null)
                    return;
